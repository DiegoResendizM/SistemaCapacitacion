...
private String generarIdConsecutivo() {
    File f = new File(ARCHIVO);
...
private void mostrarRegistro() {
    ...
    txtCalificacion.setText(r[3]); 
    txtFecha.setText(r[4]); 
}

private void limpiar() {
    txtId.setText(generarIdConsecutivo());
...
private void guardarRegistro() {
    String id = generarIdConsecutivo(); 
    ...
    if (mat.isEmpty() || cur.isEmpty() || cal.isEmpty() || fec.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Matrícula, curso, calificación y fecha son obligatorios.");
        return;
    }
    ...
    try {
        ...
        if (c < 0 || c > 100) throw new NumberFormatException();
    } catch (NumberFormatException e) {
        JOptionPane.showMessageDialog(this, "Calificación debe ser un entero entre 0 y 100.");
        return;
    }
...
private void eliminarRegistro() {
    ...
    int conf = JOptionPane.showConfirmDialog(this, "¿Eliminar esta calificación?", "Confirmar", JOptionPane.YES_NO_OPTION);
